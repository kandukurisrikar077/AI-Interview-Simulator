...
export const ResetPassword: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err?.response?.data?.detail || 'Failed to reset password. Please verify your email and try again.')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden bg-[#050816] text-white">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2 text-sm">Enter your new secure account password.</p>
        </div>

        <div className="glass-card p-8 rounded-2xl shadow-xl border border-white/5">
          <h2 className="text-2xl font-bold text-white mb-6 text-center">New Password</h2>
          ...
          {success ? (
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-gray-400 text-xs font-light">Redirecting you to log in...</p>
              </div>
            </motion.div>
          ) : (
            <>
